...
namespace QL_BanHang.View
{
    public partial class frmKhachHang : Form
    {
        ...
        {
            DialogResult dr = MessageBox.Show("Bạn chắc chắn muốn hủy ?", "Xác nhận hủy", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
            if (dr == DialogResult.Yes)
                frmKhachHang_Load(sender, e);
            else
                return;
        ...
        private void txtSoTien_DM_KeyPress(object sender, KeyPressEventArgs e)
        {
        ...
        private void btnfrmHH_Click(object sender, EventArgs e)
        {
                frmHangHoa frmMain = new frmHangHoa();
                this.Hide();
                frmMain.ShowDialog();
                Application.Exit(); 
        }
        ...
        {
            frmNhanVien frmMain = new frmNhanVien();
            this.Hide();
            frmMain.ShowDialog();
            Application.Exit();
        }
