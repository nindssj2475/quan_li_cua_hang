...
namespace QL_BanHang.View
{
    public partial class frmHoaDon : Form
    {
        ...
        {
            NhanVienCtr hhctr = new NhanVienCtr();
            cmbNhanVien.DataSource = hhctr.GetData();
        ...
        {
            txtMa.Text = "";
            dpNgayLap.Value = DateTime.Now.Date;
            LoadcmbKhachHang();
            LoadcmbNhanVien();
        }
        ...
        {
            frmKhachHang frmMain = new frmKhachHang();
            this.Hide();
            frmMain.ShowDialog();
            Application.Exit();
        }
